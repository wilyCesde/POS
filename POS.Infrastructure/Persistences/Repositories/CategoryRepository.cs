...
namespace POS.Infrastructure.Persistences.Repositories
{
    public class CategoryRepository : GenericRepository<Category>, ICategoryRepository
    {
        ...
        {
            //metodo para Listar las Categorias ya filtrado,por parametro  descripcion estado fechas y ordenado
            //por un campopor defecto y devolvemos el total de registros y total de items que quirero mostrar
        ...
        public async Task<IEnumerable<Category>> ListSelectCategories()
        {
            ...
            //devolver todas ms categorias sin filtrar es una lista
        ...
        public async Task<Category> CategoryById(int categoriaId)
        {
            var category = await _context.Categories!.AsNoTracking().FirstOrDefaultAsync
                (x => x.CategoryId.Equals(categoriaId));
            return category!;
        }
        ...
        {
            var category = await _context.Categories.AsNoTracking().SingleOrDefaultAsync
